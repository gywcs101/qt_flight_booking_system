...
void FavoritesPage::showEmptyState(QVBoxLayout *layout, QString text)
{
    ...
    icon->setStyleSheet("font-size: 60px; color: #DCDFE6; border: none; background: transparent;");
    icon->setAlignment(Qt::AlignCenter);

    // 2. 文字
    QLabel *msg = new QLabel(text);
    msg->setStyleSheet("font-size: 16px; color: #909399; font-weight: bold; border: none; background: transparent;");
